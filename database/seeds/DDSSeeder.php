...
class DDSSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DdsArticle::create(['id' => 2, 'category_id' => 9, 'name' => 'Прочие поступления', 'company_id' => null, 'locked' => true, 'dds_types_id' => 2]);
        DdsArticle::create(['id' => 3, 'category_id' => 8, 'name' => 'Погашение кредита', 'company_id' => null, 'locked' => true, 'dds_types_id' => 3]);
