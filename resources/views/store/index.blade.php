                ...
                <div class="navbar flex-nowrap white lt box-shadow" style="z-index: 1010;">
                    <div class="flex">
                        <div class="input-group">
                            <input id="search" name="search" type="text" value="{{ request('search') }}" class="form-control form-control-sm search"  placeholder="Поиск по складу">
                    ...
                    <span class="m-b btn-groups pl-1">
                        <button onclick="openDialog('categoryDialog')" class="btn btn-sm white mb-0">Новая категория</button>
                        <button onclick="openDialog('productDialog')" class="btn btn-sm white mb-0">Новый товар</button>
                    </span>
                </div>
                <div id="ajax-table-store" class="content-main d-flex flex" style="max-height: calc(100% - 57px);">
