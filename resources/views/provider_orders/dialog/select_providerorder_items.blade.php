<form id="provider_order_form" action="">
    ...
    <div data-simplebar style="max-height: 400px;">
        @foreach($providerorder->articles()->get() as $article)
            <div class="list-item inblocked mini-list-element pointer">
                <div class="inblock">
                    ...
                    <div class="w-200 list-body b-r pr-2 compressed" style="max-height: 38px;overflow: hidden;flex: 2;">
                        <label class="md-check h-20 pr-2">
                            <input id="article_provider_order_{{ $article->id }}" name="products[{{  $article->id }}][iclude]" type="checkbox" checked="">
                            <i class="success"></i>
                        </label>
                    ...
                    <div class="list-body" style="margin-top: -5px;margin-bottom: -5px; flex: 0;">
                        <input class="form-control form-control-sm" style="width: 75px" type="number" step="1" name="products[{{  $article->id }}][count]" value="{{ $article->pivot->count }}">
