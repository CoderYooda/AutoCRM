        ...
        <div class="content-rightside">
            ...
            <div class="box w-290 p-15 filter-panel">
                ...
                <div class="form-group d-flex">
                    ...
                    <div class="dropdown" onclick="window.helper.openModal(this, event)">
                        ...
                        <div class="dropdown_container">
                            ...
                            <span onclick="store.setField('pay_status', 1, 'оплачено', this)" class="element">Оплачено</span>
                            <span onclick="store.setField('pay_status', 2, 'не оплачено', this)" class="element">Не оплачено</span>
                            <span onclick="store.setField('pay_status', 3, 'оплачено частично', this)" class="element">Оплачено частично</span>
                        </div>
                    </div>
                ...
                <div class="form-group d-flex">
                    ...
                    <div class="dropdown" onclick="window.helper.openModal(this, event)">
                        <input id="entrance_status" type="text" name="entrance_status" value="{{ request('pay_status') }}" class="form-control entrance_status input_as_link" placeholder="не выбрано" disabled>
                        <div class="dropdown_container">
                            <div class="arrow"></div>
                ...
                <div class="filter_field mb-10">
                    <div class="form-group d-flex mb-5">
                        ...
                        <input onclick="store.openSelectPartnerModal('provider')" id="provider" type="text" name="provider" value="{{ request('pay_status') }}" class="form-control provider input_as_link" placeholder="выбрать">
                ...
                <div class="filter_field mb-10">
                    <div class="form-group d-flex">
                        ...
                        <input onclick="store.openSelectPartnerModal('accountable')" id="accountable" type="text" name="accountable" value="{{ request('pay_status') }}" class="form-control accountable input_as_link" placeholder="не выбрано">
