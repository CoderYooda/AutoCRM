        ...
        <div class="modal-body">
            ...
            <div class="d-flex">
                <div class="link-tabs no-pr">
                    <ul class="nav" id="entrance_refund_tabs{{ $entrance_refund ? $entrance_refund->id : '' }}" storage_tabs>
                        <li class="nav-item active">
                            <a class="nav-link" href="{{ $entrance_refund ? '#er_tab_base' . $entrance_refund->id : '#er_tab_base' }}" aria-controls="{{ $entrance_refund ? 'er_tab_base' . $entrance_refund->id : 'er_tab_base' }}" data-toggle="tab" data-target="{{ $entrance_refund ? '#er_tab_base' . $entrance_refund->id : '#er_tab_base' }}">
                                Основные
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ $entrance_refund ? '#er_tab_items' . $entrance_refund->id : '#er_tab_items' }}" aria-controls="{{ $entrance_refund ? 'er_tab_items' . $entrance_refund->id : 'er_tab_items' }}" data-toggle="tab" data-target="{{ $entrance_refund ? '#er_tab_items' . $entrance_refund->id : '#er_tab_items' }}">
                                Позиции
                                <span class="float-right helper_danger d-none-f">
                                    <i class="fa fa-exclamation-triangle text-md ml-2 text-danger"></i>
                                </span>
                ...
                <div class="dialog_tab_holder">
                    <div class="tab-content no-pl">
                        <div class="tab-pane active" id="{{ $entrance_refund ? 'er_tab_base' . $entrance_refund->id : 'er_tab_base' }}">
