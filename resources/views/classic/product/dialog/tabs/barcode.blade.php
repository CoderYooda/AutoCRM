...
{{--    @dd($product->barcode, $product->barcode_local, strlen($product->barcode) == 13, strlen($product->barcode_local) == 13)--}}
    ...
    @if($product && strlen($product->barcode) == 13 && getBarCodePNG($product->barcode) != null)
        <div class="form-group">
    ...
    @if($product && strlen($product->barcode_local) == 13 && getBarCodePNG($product->barcode_local) != null)
        <div class="form-group">
