        ...
        @forelse($entrances as $entrance)
            <div class="entrance">
                ...
                <div class="field with_input">
                    <input type="number" min="0" name="entrances[{{ $entrance->id }}][price]" value="{{ $entrance->pivot->price }}" readonly>
                </div>
                <div class="field with_input">
                    <input type="number" min="0" name="entrances[{{ $entrance->id }}][count]" value="{{ $entrance->pivot->count }}" readonly>
                </div>
            </div>
