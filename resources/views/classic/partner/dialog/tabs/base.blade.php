...
<div class="form-group fl ip ul @if(!$partner || !$partner->comment) mb-0 @endif">
    ...
    <textarea type="text" name="comment" class="form-control w-100 @if(!$partner || !$partner->comment) hide @endif" placeholder="Комментарий">@isset($partner){{ $partner->comment }}@endisset</textarea>
</div>
