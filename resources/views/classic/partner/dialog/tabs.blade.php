    ...
    <div class="ov-hidden">
        <div class="row">
            <div class="col-sm-4 no-pr d-flex">
                <ul class="nav" id="partner_tabs_{{ $class }}" role="tablist">
            ...
            <div class="col-sm-8 no-pl">
                <div class="tab-content mb-0 pl-8">
                    ...
                    <div role="tabpanel" class="tab-pane animate" aria-labelledby="tab_company{{ $class }}-tab" id="tab_company{{ $class }}">
                        @include(get_template() . '.partner.dialog.tabs.company')
                    </div>
                    <div role="tabpanel" class="tab-pane animate" aria-labelledby="tab_passport{{ $class }}-tab" id="tab_passport{{ $class }}">
                        @include(get_template() . '.partner.dialog.tabs.passport')
                    </div>
                    <div role="tabpanel" class="tab-pane animate" aria-labelledby="tab_vehicles{{ $class }}-tab" id="tab_vehicles{{ $class }}">
                        @include(get_template() . '.partner.dialog.tabs.vehicles')
                    </div>
                    <div role="tabpanel" class="tab-pane animate" aria-labelledby="tab_barcodes{{ $class }}-tab" id="tab_barcodes{{ $class }}">
                        @include(get_template() . '.partner.dialog.tabs.bar_codes')
                    </div>
                    <div role="tabpanel" class="tab-pane animate" aria-labelledby="tab_access{{ $class }}-tab" id="tab_access{{ $class }}">
                        @include(get_template() . '.partner.dialog.tabs.access')
                    </div>
                    <div role="tabpanel" class="tab-pane animate" aria-labelledby="tab_salary{{ $class }}-tab" id="tab_salary{{ $class }}">
                        @include(get_template() . '.partner.dialog.tabs.salary')
                    </div>
                </div>
            </div>
        </div>
