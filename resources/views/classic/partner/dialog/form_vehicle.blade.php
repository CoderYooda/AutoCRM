<div id="{{ $tag }}" class="dialog" style="width:600px;">
    ...
    <form id="act_form_partner" action="#" method="POST">
        ...
        <div class="modal-footer">
            <button onclick="window.{{ $tag }}.finitaLaComedia()" class="button white">Закрыть</button>
            <button type="submit" onclick="window.{{ $tag }}.save(this)" class="button pull-right">Сохранить</button>
        </div>
