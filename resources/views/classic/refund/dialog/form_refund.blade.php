    ...
    <form class="RefundStoredListner WarrantStoredListner ShipmentStoredListner" action="{{ route('StoreRefund') }}" method="POST">
        <div class="box-body">
            ...
            <input class="shipment_select" type="hidden" name="shipment_id" value=" @if(isset($refund)){{ $refund->shipment->id }} @elseif(isset($shipment)) {{ $shipment->id }} @endif">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group row row-sm">
                        ...
                        <div class="col-sm-7 input-group">
                            <input type="text" value="{{ Auth::user()->partner->outputName() }}" class="form-control" disabled>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
