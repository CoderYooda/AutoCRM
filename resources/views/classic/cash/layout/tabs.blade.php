...
<div class="side-menu w-180">
    <ul class="nav">
        <li id="warrant-tab" data-tab="store" data-default="true" class="@if($request['active_tab'] == 'warrant' || $request['active_tab'] == null) active @endif">
            <a class="ajax-nav" href="{{ route('CashIndex', ['active_tab' => 'warrant', 'target' => 'ajax-tab-content']) }}">Деньги</a>
        </li>
        <li id="cashmove-tab" data-tab="provider_orders" class="@if($request['active_tab'] == 'cashmove') active @endif">
