    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="button primary pull-right" onclick="user.cropImage(window.cropdata);">Сохранить</button>
                <button type="button" class="button primary mr-15 pull-right" onclick="user.anotherPicture()">Другое изображение</button>
            </div>
        </div>
    </div>
</div>
