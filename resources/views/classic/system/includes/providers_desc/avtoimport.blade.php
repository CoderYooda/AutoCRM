<ul class="service-list pr-15">
    ...
    <li>
        Перейдите во вкладку "Обратная связь" и в сообщение укажите, что Вам требуется доступ к проценке, так же укажите, что требуется доступ по этому IP адресу:<br>
