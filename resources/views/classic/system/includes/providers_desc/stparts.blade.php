<ul class="service-list pr-15">
    ...
    <li>
        Перейдите во вкладку "Служба поддержки клиентов" и в сообщении укажите, что Вам требуется доступ к проценке,
...
<div class="ml-15 mr-15" style="color: #404040;">
    ...
    <p>Сервис Stparts дает возможность отслеживать цены на автозапчасти в режиме реального времени, наличие на складе поставщика и сроки поставки при заказе товара.</p>
</div>
