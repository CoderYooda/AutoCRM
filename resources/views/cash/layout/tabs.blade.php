                    ...
                    <nav class="nav-border b-primary" data-nav>
                        <ul class="nav">
                            <li id="store-tab" data-tab="store">
                                <a href="{{ route('CashIndex', ['active_tab' => 'money', 'target' => 'ajax-tab-content']) }}" class="ajax-nav update_url">
                                    <span class="nav-text">Деньги</span>
                                </a>
                            </li>
                            <li id="provider-tab" data-tab="provider">
                                <a href="{{ route('CashIndex', ['active_tab' => 'cashmove', 'target' => 'ajax-tab-content']) }}" class="ajax-nav update_url">
