{{--@php $moneymove = \App\Http\Controllers\MoneyMoveController::getMoneyMoves($request) @endphp--}}
...
<div class="p-3 b-t mt-auto">
    <div class="d-flex align-items-center">
        <div class="flex">
{{--            {{ $moneymove->setPath(route('CashIndex'))->appends(request()->only(['active_tab', 'date_start', 'date_end', 'isIncoming', 'page', 'search']))->links() }}--}}
        </div>
        <div>
