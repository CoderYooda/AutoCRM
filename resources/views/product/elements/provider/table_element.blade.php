<tr>
    ...
    <td>
        <a onclick="openDialog('productDialog', '&brand={{ $brand->producer }}&article={{ $brand->article }}&provided_name={{ str_replace("'",'"', htmlspecialchars_decode($brand->ident, ENT_QUOTES)) }}' )" class="btn btn-sm badge danger text-white">Добавить</a>
    </td>
</tr>
