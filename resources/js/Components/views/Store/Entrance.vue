...
<!--                    <input v-model.lazy="search" v-debounce="450" id="search" name="search" placeholder="Поиск по поступлениям" class="input w-100" value="" type="text">-->
<!--                </div>-->
<!--                <div class="actions">-->
<!--                    -->
<!--                </div>-->
<!--            </div>-->
            <div class="d-flex" style="height: calc(100% - 45px);">
                ...
                <div>
                    <button type="button" class="button primary ml-15 mb-15 w-290" v-on:click="newDialog('product')">Создать поступление</button>
