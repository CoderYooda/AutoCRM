    ...
    public static function getShipments($request)
    {
        ...
        $shipments =
            Shipment::withoutGlobalScopes()->select(DB::raw('
                shipments.*, shipments.created_at as date, IF(partners.type = 0, partners.fio,partners.companyName) as partner, CONCAT(shipments.discount, IF(shipments.inpercents = 1, \' %\',\' ₽\')) as discount, shipments.summ as price, shipments.itogo as total
            '))
